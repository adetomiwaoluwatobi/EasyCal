                    ...
                    <div className="flex justify-center items-center bg-white p-5">
                        <div>
                            <form action="/" className="flex flex-col justify-center items-center">
                                ...
                                <div>
                                <input type="text" className="rounded-lg" name="" id="" placeholder='username' />
                                <p className=''><small>must be unique</small></p>
                                <input type="email" className="rounded-lg" name="" id="" placeholder='Email' />
                                <input type="password" className="rounded-lg" name="" id="" placeholder='password' />
                                <p className=''><small>must be unique</small></p>
                                <div>
                                    <input type="checkbox" name="" id="" />
                                    I accept the <a href="#">Terms and condition</a>
                                </div>
                                <button className='rounded-full bg-blue-950'>Sign up</button>
                                or 
                                <p>Sign up with</p>
                                <button className='rounded-sm bg-blue-100'>
